          ...
          <div class="cat-card card">
            <div class="cat-image">
              ...
              <div class="cat-overlay">
                <button class="btn btn-sm btn-primary" (click)="editCat(cat)">
                  Edit
                </button>
                <button
            ...
            <div class="cat-info">
              ...
              <span
                class="badge"
                [class]="cat.isActive ? 'badge-success' : 'badge-muted'"
              >
              ...
              <div class="upload-area" (click)="imgInput.click()">
                @if (form.image) {
                  <img
                    ...
                    style="max-height:120px;border-radius:8px;margin:0 auto"
                  />
                } @else {
