    ...
    <div class="home page-enter">
          ...
          @for (banner of banners(); track banner.id) {
            ...
            >
              ...
              <div class="hero-content container">
                ...
                <a
                  [routerLink]="banner.ctaLink || '/products'"
      ...
      <section class="hero-fallback" *ngIf="!banners().length">
        ...
        <div class="hero-fallback-content container">
          ...
          <p class="hero-fallback-sub">
            Handcrafted crochet clothing for the modern woman.
          </p>
      ...
      <section class="section featured-section">
        <div class="container">
          ...
          <div class="text-center mt-3" style="margin-top: 48px;">
            <a routerLink="/products" class="btn btn-outline-accent btn-lg"
              >View All Products →</a
            >
          </div>
        </div>
      ...
      <section class="story-section">
        ...
        <div class="container story-content">
          <div class="story-text">
            ...
            <p>
              Every stitch in our collection carries the warmth of handcraft and
              the story of our artisans. We believe fashion should be personal,
              sustainable, and deeply human.
            </p>
            <a routerLink="/about" class="btn btn-outline-accent mt-3"
...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.products.getFeatured().subscribe({
      next: (p) => {
        this.featured.set(p);
  ...
  nextSlide() {
    this.currentSlide.update(
      (s) => (s + 1) % Math.max(this.banners().length, 1),
    );
  }
  prevSlide() {
    this.currentSlide.update(
      (s) =>
        (s - 1 + Math.max(this.banners().length, 1)) %
        Math.max(this.banners().length, 1),
    );
  }
  goToSlide(i: number) {
