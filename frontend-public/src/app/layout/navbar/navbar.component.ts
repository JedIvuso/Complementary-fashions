  ...
  template: `
    <header [class.scrolled]="scrolled()" class="navbar">
          ...
          <ng-container *ngIf="authService.isLoggedIn(); else loginBtn">
            <div class="user-menu-wrapper">
              ...
              <div class="user-dropdown" *ngIf="showUserMenu()">
                ...
                <a routerLink="/orders" (click)="showUserMenu.set(false)"
                  >My Orders</a
                >
                <a routerLink="/favorites" (click)="showUserMenu.set(false)"
                  >Favorites</a
                >
      ...
      <div class="mobile-nav" [class.open]="mobileMenuOpen()">
        ...
        <a routerLink="/favorites" (click)="mobileMenuOpen.set(false)"
          >Favorites</a
        >
        <a routerLink="/orders" (click)="mobileMenuOpen.set(false)"
          >My Orders</a
        >
      </div>
    </header>
