...
@Component({
    ...
    <footer class="footer">
      <div class="footer-inner container">
        <div class="footer-brand">
          ...
          <p class="brand-desc">Handcrafted crochet clothing woven with love and worn with pride. Each piece tells a unique story.</p>
        ...
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="mailto:hello@complementaryfashions.com">Contact</a></li>
  ...
  styles: [`
    ...
    .footer-inner {
      ...
      gap: 48px; padding-top: 64px; padding-bottom: 48px;
    }
    .brand-logo { display: flex; align-items: center; gap: 10px; margin-bottom: 16px; }
    .brand-icon { font-size: 1.75rem; color: var(--color-accent); }
    .brand-name { font-family: var(--font-display); font-size: 1.25rem; color: var(--color-text); }
    .brand-tagline { font-family: var(--font-accent); color: var(--color-accent); font-size: 0.875rem; }
    .brand-desc { font-size: 0.875rem; line-height: 1.7; color: var(--color-text-secondary); margin-bottom: 20px; }
    .social-links { display: flex; gap: 12px; }
    .social-link {
      width: 38px; height: 38px; border-radius: 50%; display: flex; align-items: center;
      justify-content: center; background: var(--color-surface-2);
      border: 1px solid var(--color-border); text-decoration: none; font-size: 1rem;
      transition: all 0.3s;
    }
    .social-link:hover { background: var(--color-accent); border-color: var(--color-accent); transform: translateY(-2px); }
    .footer-col h4 {
